...
import { RegistrationForm } from '../toolbar/my-ayab-menu/registration-form/registration-form';
import { LoginForm } from '../toolbar/my-ayab-menu/login-form/login-form';
import { SettingsForm } from '../toolbar/my-ayab-menu/settings-form/settings-form';
